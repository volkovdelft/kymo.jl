...
run("Duplicate...", "title=dummy duplicate channels=1-2 slices=n");
run("Split Channels");
...
run("Merge Channels...", "c1=C1-dummy c2=C2-dummy create");
run("Merge Channels...", "c1=[AVG_Reslice of C1-dummy-1] c2=[AVG_Reslice of C2-dummy-1] create ");
